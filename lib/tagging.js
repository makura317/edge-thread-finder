export const TAG_RULES = [
  { type: '種別', value: '実況', patterns: [/実況/, /NHKBS/i, /【(?:NHK|フジ|TBS|テレ朝|日テレ|テレ東|TX|BS|ABEMA)/i, /★\d+$/] },
  { type: '話題', value: 'アニメ', patterns: [/アニメ/, /ONE\s*PIECE/i, /ワンピース/, /ドラゴンボール/, /Liella!/i] },
  { type: '話題', value: 'ゲーム', patterns: [/ゲーム/, /ゼルダ/, /任天堂/, /Nintendo/i, /amiibo/i] },
  { type: '話題', value: '音楽', patterns: [/音楽/, /Spotify/i, /曲/, /歌詞/, /フジロック/] },
  { type: '話題', value: '芸能', patterns: [/松本人志/, /芸人/, /テレビタレント/] },
  { type: '話題', value: 'スマホ', patterns: [/iPhone/i, /Android/i, /Pixel\b/i, /スマホ/] },
